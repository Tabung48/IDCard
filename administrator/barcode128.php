...
.angka{font:10px "Calibri"; color:#4d4d4d;}
</style>
...
$html .= "
<td>
<div class=\"b128\" style=\"border-left-width:{$w[$x]};width:{$w[$x+1]}; width:80%;\"></div>
";
return "$html
<tr><td  colspan=".strlen($w)." align=center><b class=\"angka\">$text</table>
";
}
?>